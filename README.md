...
- Understand GitOps principles, desired state and reconciliation
- Understand declarative infrastructure and applications
- Learn the Kubernetes fundamentals required for GitOps
- Learn Argo CD and pull-based deployment
- Build GitOps-based deployments
- Learn Kustomize and Helm
- Implement CI + GitOps
- Manage multiple environments
- Understand GitOps security and deployment strategies
...
The sections will be added incrementally as the course progresses.
...
```text
Learn → Build → Deploy → Break → Troubleshoot → Fix → Document
```
...
+ Kubernetes + Argo CD + Kustomize + Helm
+ Security + Monitoring
```
